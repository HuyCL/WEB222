...
window.onload = function() {
    var imgDiv = document.getElementById('image');      // Find container in HTML file that matches ID
    var imgString = "<figure>";        // Variable to concatenate string

    images.forEach(function(img) {
        imgString += "<img src='" + img.url + "' alt='" + img.alt + "'><figcaption>" + img.caption + "</figcaption></figure><br>";
    });

    imgDiv.innerHTML += imgString;      // Append string to HTML container
};